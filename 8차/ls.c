...
//////////////////////////////////////////////////// 
static int maxNchildren;		// child max cnt
...
{	
	...
	//////////////////////////////////////////////////// 
	maxNchildren=5;				
	for(i=0;i<maxNchildren;i++){	// making child process
...
void child_main(int socketfd)
{
   ...
   while(1){
		...
		for(i=0 ; i<4 ; i++)					// delete allocation
			free(argv[i]);
		free(argv);
		kill(getppid(), SIGUSR1);				// send signal of SIGUSR1 to parent
		exit(0);								// process exit
	}
}
////////////////////////////////////////////////// 
